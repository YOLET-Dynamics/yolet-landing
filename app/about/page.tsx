            ...
            <div className="mx-auto max-w-3xl px-2 text-center">
              ...
              <div className="animate-on-scroll opacity-0 transition-all duration-700 ease-in delay-300 [&.animate-in]:translate-y-0 [&.animate-in]:opacity-100 -translate-y-8">
                <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300 md:text-xl">
                  We're on a mission to transform how businesses and communities
              ...
              <div className="animate-on-scroll opacity-0 transition-all duration-700 ease-in [&.animate-in]:translate-y-0 [&.animate-in]:opacity-100 translate-y-8">
                <div className="rounded-xl border border-white/10 bg-gray-900/30 p-8 md:p-12">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    empower businesses to grow, and help communities thrive. Our
                    goal is to deliver solutions that are not only functional
                    and elegant but also deeply rooted in understanding the real
              ...
              <div className="animate-on-scroll opacity-0 transition-all duration-700 ease-in [&.animate-in]:translate-y-0 [&.animate-in]:opacity-100 translate-y-8">
                <div className="rounded-xl border border-white/10 bg-gray-900/30 p-8 md:p-12">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    progress. We envision technology built with people, not just
                    for them—where intuitive design and thoughtful innovation
                    enable individuals to focus on what truly matters: growing
                    their dreams, solving local challenges, and connecting in a
                    digital world.
                  </p>
                </div>
              </div>
              ...
              <div className="animate-on-scroll opacity-0 transition-all duration-700 ease-in [&.animate-in]:translate-y-0 [&.animate-in]:opacity-100 translate-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="rounded-xl border border-white/10 bg-gray-900/30 p-6 md:p-8 h-full">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      We put ourselves in our users' shoes, understanding their
                      needs, challenges, and aspirations to create solutions
                      that truly resonate and make a difference in their lives.
                    </p>
                  </div>
            ...
            <div className="mx-auto max-w-4xl text-center">
              <div className="animate-on-scroll opacity-0 transition-all duration-700 ease-in [&.animate-in]:translate-y-0 [&.animate-in]:opacity-100 translate-y-8">
                ...
                <p className="text-gray-300 leading-relaxed mb-12 max-w-2xl mx-auto">
                  ...
                  united by a passion for creating technology that makes a
                  difference.
                </p>
